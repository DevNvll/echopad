...
export const NoteImage: React.FC<NoteImageProps> = ({ src, alt, vaultPath, notebookName }) => {
  ...
  useEffect(() => {
    const loadImage = async () => {
      try {
        ...
        const fullPath = `${normalizedVault}/${notebookName}/${normalizedSrc}`;
